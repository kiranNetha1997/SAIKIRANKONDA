...
import { CloseEvent, Command, CommandIdentifier, TimerEvent } from 'concurrently/dist/src/command';
import { concurrently, ConcurrentlyCommandInput, ConcurrentlyOptions as BaseConcurrentlyOptions, ConcurrentlyResult } from 'concurrently/dist/src/concurrently';
import { FlowController } from 'concurrently/dist/src/flow-control/flow-controller';
import { InputHandler } from 'concurrently/dist/src/flow-control/input-handler';
import { KillOnSignal } from 'concurrently/dist/src/flow-control/kill-on-signal';
import { KillOthers, ProcessCloseCondition } from 'concurrently/dist/src/flow-control/kill-others';
import { LogError } from 'concurrently/dist/src/flow-control/log-error';
import { LogExit } from 'concurrently/dist/src/flow-control/log-exit';
import { LogOutput } from 'concurrently/dist/src/flow-control/log-output';
import { LogTimings } from 'concurrently/dist/src/flow-control/log-timings';
import { RestartProcess } from 'concurrently/dist/src/flow-control/restart-process';
