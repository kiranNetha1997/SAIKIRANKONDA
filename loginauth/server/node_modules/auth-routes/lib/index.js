...
function registerAuthRoutes(app, options) {
    var _this = this;
    var opts = __assign({ afterLogin: '/', callbackURL: '/login/cb', loginURL: '/login' }, options);
    app.get(opts.loginURL, function (req, res) {
    ...
    app.get(opts.callbackURL, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var params, tokenRes;
